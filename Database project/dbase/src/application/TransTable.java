...
Main.PrimaryStage.centerOnScreen();
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		try {	
			...
			String lanesel=TransScene.laneSelected;
			ResultSet rs = DataBaseConnection.read("SELECT * FROM mydb.timetable t WHERE t.Day= '"+daysel+"' AND t.Clock= '"+timesel+"' AND t.LName= \""+lanesel+"\"") ; 
