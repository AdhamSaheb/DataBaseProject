...
public class DriverReport2Controller implements Initializable {
...
Main.PrimaryStage.setScene(Main.FirstScene);//change to entity scene
    }
    URL arg0;
    ResourceBundle arg1;
    @FXML
...
initialize(arg0,arg1);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		list.clear();
		try {	
			ResultSet rs = DataBaseConnection.read("SELECT * FROM mydb.driver where Start_Date like '2018-%-%' ") ; 
